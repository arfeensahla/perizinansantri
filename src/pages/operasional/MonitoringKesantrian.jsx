...
const MonitoringKesantrian = () => {
    ...
    // --- Data Dummy Global (Tanpa Nomor Induk & Sesuai Kamus Standar) ---
    const [dataSantriLuar] = useState([
        { id: 'S-001', nama: 'Dimas Anggara', kelas: '7A', walikelas: 'Ustadz Zulfikar', hpWalikelas: '081234567890', jenisIzin: 'PULANG_PERGI_WALI', tujuan: 'Cirebon', batasWaktu: '21 September 2026, 09:00 WIB', status: 'TERLAMBAT', durasiTelat: '1 Jam 55 Menit' },
        { id: 'S-002', nama: 'Tariq bin Ziyad', kelas: '8B', walikelas: 'Ustadz Mahmud', hpWalikelas: '081987654321', jenisIzin: 'PULANG_MENGINAP_WALI', tujuan: 'Bandung', batasWaktu: '20 September 2026, 17:00 WIB', status: 'TERLAMBAT', durasiTelat: '17 Jam 55 Menit' },
        { id: 'S-003', nama: 'Zaid bin Tsabit', kelas: '9A', walikelas: 'Ustadz Hasan', hpWalikelas: '085612345678', jenisIzin: 'RUJUK_INAP_KLINIK', tujuan: 'RSUD Majalengka', batasWaktu: '23 September 2026, 12:00 WIB', status: 'DI_LUAR', durasiTelat: '-' },
        { id: 'S-004', nama: 'Ahmad Muzakki', kelas: '7A', walikelas: 'Ustadz Zulfikar', hpWalikelas: '081234567890', jenisIzin: 'PULANG_MENGINAP_WALI', tujuan: 'Kuningan', batasWaktu: '22 September 2026, 15:00 WIB', status: 'DI_LUAR', durasiTelat: '-' },
        { id: 'S-005', nama: 'Fathan Mubin', kelas: '8A', walikelas: 'Ustadz Anwar', hpWalikelas: '081345678901', jenisIzin: 'PULANG_PERGI_WALI', tujuan: 'Cirebon', batasWaktu: '21 September 2026, 15:00 WIB', status: 'DI_LUAR', durasiTelat: '-' },
    ]);
                                ...
                                <tr>
                                    <td colSpan="4" className="px-6 py-12 text-center">
                                        <div className="flex flex-col items-center justify-center text-gray-400">
                                            ...
                                            <p className="text-base font-bold text-gray-600">Alhamdulillah, Semua Hadir!</p>
